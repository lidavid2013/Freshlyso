...
!function (a, b) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b(a) : "function" == typeof define && define.amd ? define("colors", [], function () {
    return b(a);
  }) : a.Colors = b(a);
}(void 0, function (a, b) {
  "use strict";
  ...
  function h(a, b) {
    for (var c = b ? 1 : 255, d = [a.r / c, a.g / c, a.b / c], e = o.options.luminance, f = d.length; f--;) {
      d[f] = d[f] <= 0.03928 ? d[f] / 12.92 : m.pow((d[f] + 0.055) / 1.055, 2.4);
    }
  ...
  function j(a, b) {
    var c = 1;
    return c = a >= b ? (a + 0.05) / (b + 0.05) : (b + 0.05) / (a + 0.05), n(100 * c) / 100;
  }
  ...
  var v = {
    txt2color: function txt2color(a) {
      var b = {},
          c = a.replace(/(?:#|\)|%)/g, "").split("("),
          d = (c[1] || "").split(/,\s*/),
          e = c[1] ? c[0].substr(0, 3) : "rgb",
          f = "";
      if (b.type = e, b[e] = {}, c[1]) for (var g = 3; g--;) {
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b(a, require("jquery"), require("colors")) : "function" == typeof define && define.amd ? define(["jquery", "colors"], function (c, d) {
    return b(a, c, d);
    ...
    return c = b.extend({
      ...
      f.data("colorMode", d[1] ? d[0].substr(0, 3) : "HEX").attr("readonly", r.preventFocus), c.doRender && f.css({
        ...
        color: function color() {
          return q.setColor(a).rgbaMixBGMixCustom.luminance > 0.22 ? c.dark : c.light;
        }
      });
    });
