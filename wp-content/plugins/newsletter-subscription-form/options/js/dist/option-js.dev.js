...
jQuery(document).ready(function () {
  // rate it option js
  jQuery(".rating-stars").find("a").hover(function () {
  ...
  jQuery(".color").colorPicker(); // Switch Click

  jQuery(".Switch").click(function () {
    // Check If Enabled (Has 'On' Class)
    if (jQuery(this).hasClass("On")) {
      // Try To Find Checkbox Within Parent Div, And Check It
      jQuery(this).parent().find("input:checkbox").attr("checked", true); // Change Button Style - Remove On Class, Add Off Class

      jQuery(this).removeClass("On").addClass("Off");
    } else {
      // If Button Is Disabled (Has 'Off' Class)
      // Try To Find Checkbox Within Parent Div, And Uncheck It
      jQuery(this).parent().find("input:checkbox").attr("checked", false); // Change Button Style - Remove Off Class, Add On Class
