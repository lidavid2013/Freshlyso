...
!(function(a, b) {
  ...
  function e(a, b) {
    ...
    if ("alpha" !== a) {
      for (var A in t)
        if (!t[A][A]) {
          a !== A && ((x = y[A] || "rgb"), (q[A] = r[x + "2" + A](q[x]))), u[
            A
          ] || (u[A] = {}), (c = q[A]);
          for (w in c) u[A][w] = n(c[w] * t[A][w][1]);
        }
      (z = u.rgb), (q.HEX = r.RGB2HEX(z)), (q.equivalentGrey =
        s.grey.r * q.rgb.r +
        s.grey.g * q.rgb.g +
        s.grey.b * q.rgb.b), (q.webSave = e = f(z, 51)), (q.webSmart = k = f(
        z,
        17
      )), (q.saveColor =
        z.r === e.r && z.g === e.g && z.b === e.b
          ...
          : z.r === k.r && z.g === k.g && z.b === k.b
            ? "web smart"
            : ""), (q.hueRGB = v.hue2RGB(q.hsv.h)), b &&
        (q.background = d(z, q.rgb, q.alpha));
    }
    var B,
      C,
      D,
  ...
  var l = {
    ...
    t = function(a, d) {
      ...
      (e = f.customBG), (f.customBG =
        "string" == typeof e ? v.txt2color(e).rgb : e), (p = c(
        a.colors,
        f.color,
        b,
        !0
  ...
  (s.prototype.setColor = function(a, d, f) {
    ...
    return u(this), (this.options.customBG =
      "string" == typeof a ? v.txt2color(a).rgb : a), c(this.colors, b, "rgb");
  ...
  var v = {
    ...
    rgb2hsv: function(a) {
      var b,
        ...
        g = a.b,
        h = 0;
      return g > f && ((f = g + ((g = f), 0)), (h = -1)), (c = g), f > e &&
        ((e = f + ((f = e), 0)), (h = -2 / 6 - h), (c = m.min(f, g))), (b =
        e - c), (d = e ? b / e : 0), {
        h:
          1e-15 > d
            ? (p && p.hsl && p.hsl.h) || 0
  ...
  function i() {
    return b("head")[r.cssPrepend ? "prepend" : "append"](
      ...
      .show(0, function() {
        (p.$UI = t = b(
          this
        )), (F = r.GPU && t.css("perspective") !== d), (u = b(".cp-z-slider", this)), (v = b(".cp-xy-slider", this)), (w = b(".cp-xy-cursor", this)), (x = b(".cp-z-cursor", this)), (y = b(".cp-alpha", this)), (z = b(".cp-alpha-cursor", this)), r.buildCallback.call(p, t), t.prepend("<div>").children().eq(0).css("width", t.children().eq(0).width()), (t._width = this.offsetWidth), (t._height = this.offsetHeight);
      })
      .hide();
  }
  function j(a) {
  ...
  function k(a) {
    ...
    q.setColor({ s: c / v._width * 100, v: 100 - d / v._height * 100 }, "hsv");
  }
  function l(a) {
  ...
  function n(a) {
    ...
    }), (w._css = { transform: n + "(" + k + "px, " + l + "px, 0)", left: F ? "" : k, top: F ? "" : l, borderColor: b.RGBLuminance > 0.22 ? e : f }), (x._css = { transform: n + "(0, " + j + "px, 0)", top: F ? "" : j, borderColor: "transparent " + h }), (y._css = { backgroundColor: "#" + b.HEX }), (z._css = { transform: n + "(" + m + "px, 0, 0)", left: F ? "" : m, borderColor: i + " transparent" }), (s._css = { backgroundColor: t ? "" : g, color: t ? "" : b.rgbaMixBGMixCustom.luminance > 0.22 ? e : f }), (s.text = t ? "" : p !== g ? g : ""), a !== d ? o(a) : G(o);
  }
  function o(a) {
    v.css(
      v._css
    ), w.css(w._css), x.css(x._css), y.css(y._css), z.css(z._css), r.doRender && s.css(s._css), s.text && s.val(s.text), r.renderCallback.call(p, s, "boolean" == typeof a ? a : d);
  }
  var p,
    q,
    r,
  ...
  (J.prototype = { render: n, toggle: h }), (b.fn.colorPicker = function(c) {
    var d = this,
      f = function() {};
    return (c = b.extend(
      {
      ...
      }), (B = B.add(this)), (this.colorPicker =
      p || new J(c)), (this.options = c), b(c.body)
      .off(".tcp")
      .on(D, function(a) {
      ...
      .each(function() {
        ...
        f
          ...
          .attr("readonly", r.preventFocus), c.doRender &&
          f.css({
            "background-color": a,
            color: function() {
