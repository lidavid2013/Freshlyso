...
<?php if( get_theme_mod('lzrestaurant_title') != ''){ ?>
  <section id="feature-pro">
      ...
      <?php if( get_theme_mod('lzrestaurant_title') != ''){ ?>
        ...
        <img src="<?php echo esc_url(get_theme_mod('food_restaurant_product_sec_border',get_template_directory_uri().'/assets/images/border.png')); ?>" alt="<?php esc_attr('Product Title Image','lzrestaurant') ?>">
      <?php }?>
